...
basedir = "src/mkdocstrings_handlers/go/templates/material"
print("theme/")
...
See them [in the repository](https://github.com/mkdocstrings/mkdocstrings-go/tree/main/src/mkdocstrings_handlers/go/templates/).
